...
seaborn.heatmap(corr_df, annot=True, fmt = '.2f', ax=ax)
seaborn.color_palette("rocket", as_cmap=True)
...
seaborn.distplot(Selected_df.HighBP, bins=20, ax=ax[0,0], color="red")
seaborn.distplot(Selected_df.HighChol, bins=20, ax=ax[0,1], color="red")
seaborn.distplot(Selected_df.BMI, bins=20, ax=ax[1,0], color="blue")
seaborn.distplot(Selected_df.PhysActivity, bins=20, ax=ax[1,1], color="blue")
seaborn.distplot(Selected_df.Age, bins=20, ax=ax[2,1], color="green")
seaborn.distplot(Selected_df.HeartDiseaseorAttack, bins=20, ax=ax[2,1], color="green")
seaborn.distplot(Selected_df.GenHlth, bins=20, ax=ax[3,0], color="#b640d4")
seaborn.distplot(Selected_df.Diabetes_Class, bins=20, ax=ax[3,1], color="#b640d4")
plt.show()

fig4, ax = plt.subplots(figsize=(10, 5))
seaborn.boxplot(Selected_df['BMI'])
plt.show()
